...
Wiki hiện tại chứa thông tin về hai chủ đề lớn:
1. **Kiến trúc LLM Wiki**: Triết lý và thiết kế quản lý tri thức cá nhân sử dụng mô hình ngôn ngữ lớn để compile tri thức thành dạng Markdown.
2. **Chiến lược Thanh toán số Haiti**: Giải pháp phát triển tài chính toàn diện tại Haiti do VDS đề xuất, xoay quanh hệ sinh thái Natcash Merchant, dự án PINASSI, thiết bị Soundbox và các hạ tầng liên ngân hàng quốc gia (SPIH, PRONAP, Switch BRH).

---

## 📂 concepts/

> Khái niệm lý thuyết, framework, định nghĩa cốt lõi

| Trang | Tóm tắt 1 dòng | Trạng thái |
|---|---|---|
...
> Người, công ty, sản phẩm, tổ chức cụ thể

| Trang | Tóm tắt 1 dòng | Trạng thái |
|---|---|---|
| [[entities/andrej-karpathy]] | Nhà nghiên cứu trí tuệ nhân tạo nổi tiếng đề xuất LLM Wiki | stable |
...
> Tổng hợp chéo nhiều nguồn, so sánh, phân tích
...
| Trang | Tóm tắt 1 dòng | Trạng thái |
|---|---|---|
| [[timelines/haiti-digital-payment-timeline]] | Dòng thời gian phát triển ví Natcash và lộ trình go-live dự án PINASSI tại Haiti | stable |

---

## 🗂️ Tất cả tags đang dùng

`#concept`, `#architecture`, `#knowledge-management`, `#entity`, `#person`, `#ai-researcher`, `#fintech`, `#mobile-money`, `#haiti`, `#merchant`, `#hardware`, `#soundbox`, `#payment-notification`, `#company`, `#natcom`, `#framework`, `#regulation`, `#financial-inclusion`, `#infrastructure`, `#dpi`, `#india-stack`, `#synthesis`, `#strategy`, `#roadmap`, `#vds`, `#viettel`, `#payment-platform`, `#payment-switch`, `#bank`

---

## 🔍 Khoảng trống kiến thức (Knowledge Gaps)
...
*INDEX này được duy trì tự động bởi Antigravity 2.0 | llm-wiki skill*
*Không chỉnh sửa thủ công — thay vào đó hãy ra lệnh cho agent cập nhật*
